"""`aegis-research list --status complete` was returning nothing.
...
Part of #2122 (aegis-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "aegis-research"
    loader = importlib.machinery.SourceFileLoader("aegis_research_cli", str(path))

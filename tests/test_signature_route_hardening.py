...
@pytest.mark.parametrize(
    ...
    # Explicit ids: the oversized payload otherwise becomes a ~64KB test id,
    # which blows past Windows' 32767-char env-var limit when pytest exports
    # PYTEST_CURRENT_TEST.
    ids=["empty", "not-base64", "not-a-png", "jpeg-data-url", "oversized"],
)

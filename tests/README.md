...
```text
[order-report] working directory: /path/to/aegis
...
[order-report] reproduce with: /path/to/aegis/venv/bin/python /path/to/aegis/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```

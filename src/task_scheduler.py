...
class TaskScheduler:
    ...
    async def _deliver_via_email(self, output: str, task, result: str):
        ...
        try:
            ...
            msg["X-Aegis-Origin"] = "aegis-ui"
            msg["X-Aegis-Kind"] = "task"
            msg["X-Aegis-Ref"] = str(task.id)
    ...
    async def _deliver_via_mcp(self, tool_name: str, task, result: str):
        ...
        args = {
            ...
            "body": result,
            "headers": {
                "X-Aegis-Origin": "aegis-ui",
                "X-Aegis-Kind": "task",
                "X-Aegis-Ref": str(task.id),
            },
        }
        if recipient:
    ...
    async def stop_background_tasks_for_foreground(self, *, reason: str = "Aegis became active") -> int:
        ...
        user opens or uses Aegis, foreground interaction wins immediately.

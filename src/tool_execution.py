...
def _is_sensitive_path(resolved: str) -> bool:
    ...
    """
    # Split on both separators: Windows accepts / and \ interchangeably, and
    # callers may pass POSIX-style paths, so splitting on os.sep alone would
    # let "C:/Users/x/.ssh/id_rsa" through on Windows.
...
def _tool_path_roots() -> list[str]:
    ...
    # Platform temp dir — on Windows this is %LOCALAPPDATA%\Temp, which the
    # /tmp entries above never cover; on POSIX it duplicates /tmp and is
    # removed by the dedup pass below.
    import tempfile
...
_EMAIL_MCP_OWNER_ARG = "_aegis_owner"

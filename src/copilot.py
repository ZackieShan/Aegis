...
COPILOT_USER_AGENT = os.environ.get(
    "AEGIS_COPILOT_USER_AGENT", "Aegis/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "AEGIS_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "AEGIS_COPILOT_EDITOR_VERSION", "Aegis/1.0"
)

...
async def action_run_script(owner: str, script: str = "", host: str = "", **kwargs) -> Tuple[str, bool]:
    ...
    target_host = (host or os.getenv("AEGIS_SCRIPT_HOST", "localhost")).strip()
                ...
                try:
                    ...
                    for uid_b in uids:
                        ...
                        try:
                            ...
                            _ody_origin = (msg.get("X-Aegis-Origin") or "").strip().lower()
                            _ody_kind = (msg.get("X-Aegis-Kind") or "").strip().lower()
                            ...
                            if (_ody_origin == "aegis-ui" or _ody_kind == "reminder"
                                    or _raw_subj.startswith("reminder (aegis):")
...
BUILTIN_ACTION_INFO = {
    ...
    "run_script": "Run a script locally or on AEGIS_SCRIPT_HOST",

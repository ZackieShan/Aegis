...
INTERNAL_TOOL_TOKEN = os.environ.get("AEGIS_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Aegis-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Aegis-Internal-Token), or

...
export const THEMES = {
  // Aurora — near-black night sky with violet/magenta streaks and an indigo
  // glow. Default theme; keep in sync with the :root fallbacks in style.css
  // and login.html.
  aurora:     { bg:'#0a0512', fg:'#cbb8ec', panel:'#120a1c', border:'#3a2657', red:'#b45de0' },
...
const UI_SCALE_KEY = 'aegis-ui-scale';
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'aegis_' + (obj.name || 'theme') + '.json';
      a.click();

...
const _rememberedDockKey = (id) => `aegis-modal-remembered-dock-${id}`;
...
const _LABELS = {
  ...
  'gallery-modal':     { label: 'Studio',   icon: 'M3 3h18v18H3zM8.5 8.5l3 3M21 15l-5-5L5 21' },
...
const _DOCK_STORAGE_KEY = 'aegis.mobileDockState.v1';

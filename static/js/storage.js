...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'aegis-model-expanded',
  MODEL_ENDPOINTS: 'aegis-model-endpoints',
  MODEL_SELECTED: 'aegis-selected-model',
  SORT_ORDER: 'aegis-sessions-sort',
  CHAT_SEARCH_SCOPE: 'aegis-search-scope',
  INCOGNITO: 'aegis-incognito',
  RAG_ACTIVE: 'aegis-rag-active',
  MCP_ACTIVE: 'aegis-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'aegis-density',
  UI_SCALE: 'aegis-ui-scale',
  WORKSPACE: 'aegis-workspace'
};

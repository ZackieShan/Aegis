...
//
// Several primary controls in Aegis are authored as click-only <div>s
// (most notably the whole sidebar navigation: New Chat, Search, Brain,
// Calendar, Compare, Cookbook, Deep Research, Studio, Library, Notes,
...
(function () {
  ...
  // ---- Modal dialogs -----------------------------------------------------
  // Aegis modals are plain <div class="modal-content"> boxes. Marking

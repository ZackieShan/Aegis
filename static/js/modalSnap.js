...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'aegis-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'aegis-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('aegis:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();

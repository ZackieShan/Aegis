"""scripts/_lib/cli.py — shared scaffolding for the `aegis-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("aegis-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/aegis-foo`
...
VERSION = "0.1.0"  # bumped centrally; every aegis-* CLI reports this
